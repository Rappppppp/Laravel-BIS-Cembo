...
<link rel="stylesheet" href="{{ asset('storage/stylesheets/services/fire-dept.css') }}">
<link rel="stylesheet" href="{{ asset('storage/stylesheets/services/firedept-responsive.css') }}">
<title>
    Fire Department
</title>
            ...
            <main>
                <div class="content">
                    <div class="bg-image" style="background-image: url('{{ asset('storage/images/services/background.png') }} ');">
                        <div class="container-fluid" id="fire-department">
                            <p class="title"> FIRE DEPARTMENT </p>
                            ...
                            <img src="{{ asset('storage/images/services/fire-dept.jpg') }}" id="img-firedept">
                        </div>
                        <!--RESCUE-->
                        <div class="container-fluid" id="rescue-container">
                            <div class="row">
                                <div class="col">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-7 col-sm-4">
                                            <img src="{{ asset('storage/images/services/rescue.jpg') }}" id="rescue">
                                        </div>
                                        <div class="col">
                                            <p class="titlecap">RESCUE</p>
                                            <p class="textcontent">Health centers provide access to basic health
                                                care
                        ...
                        <!--INSPECTION-->
                        <div class="container-fluid" id="inspection-container">
                            <div class="row">
                                <div class="col">
                                    <p class="titlecap1"> INSPECTION</p>
                                    <p class="textcontent1">Health centers provide access to basic health care
                                        services in the communities that need them most. Their doors are open
                                        to everyone – families and children, farm workers and the homeless,
                                        and those who are uninsured, on Medicaid, or have private insurance.</p>
                                </div>
                                <div class="col-lg-6 col-md-7 col-sm-4">
                                    <img src="{{ asset('storage/images/services/inspection.jpg') }}" id="inspection">
                                </div>
                            </div>
                        </div>
                        <!--TRAINING-->
                        <div class="container-fluid" id="training-container">
                            <div class="row">
                                <div class="col">
                                    <img src="{{ asset('storage/images/services/training.jpg') }}" id="training">
                                </div>
                                <div class="col-lg-6 col-md-4 col-sm-4">
                                    <p class="titlecap2">TRAINING</p>
                        ...
                        <div class="container-fluid" id="seminar-container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-7 col-sm-4">
                                    <img src="{{ asset('storage/images/services/fire-seminar.jpg') }}" id="seminar">
                                </div>
                            </div>
                        </div>
                    </div>
